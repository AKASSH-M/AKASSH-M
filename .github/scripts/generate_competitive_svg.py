...
OUT  = sys.argv[1] if len(sys.argv) > 1 else os.path.join(HERE, "..", "..", "assets", "competitive.svg")
...
svg.append(f'<text x="{W//2}" y="{TITLEBAR//2+5}" fill="{TITLE_CLR}" font-size="14" '
           f'text-anchor="middle">akassh@github: ~/competitive</text>')
